...
namespace FcisArchiveBlazor.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<FCISQuestionsHub.Core.Models.StudentUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    username = _userManager.Users.FirstOrDefault(u => u.Email == Input.Email)?.UserName 
                        ?? Input.Email.Substring(0, Input.Email.IndexOf('@'));
