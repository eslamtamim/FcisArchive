...
namespace FcisArchiveBlazor.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public TwoFactorAuthenticationModel(
            UserManager<FCISQuestionsHub.Core.Models.StudentUser> userManager, SignInManager<FCISQuestionsHub.Core.Models.StudentUser> signInManager, ILogger<TwoFactorAuthenticationModel> logger)
        {
